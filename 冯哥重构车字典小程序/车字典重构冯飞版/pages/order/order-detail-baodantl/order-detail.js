...
Page({
  ...
  data: {
    ...
    share_path: 'pages/order/order-detail-baodantl/order-detail',
  },
  ...
  callback: function (car_data) {
    ...
    var two = car_data.data.itemData[1].itemPropValue;
    // 隐藏车主名字
    two[26].itemPropValue = util.encryptionStr(two[26].itemPropValue,2)
    //城市
    two[2].itemPropValue = code.citycode[two[2].itemPropValue]
    // //使用性质
    // two[3].itemPropValue = code.carusedtype[two[3].itemPropValue]
    // //条款种类
    // two[4].itemPropValue = code.prooftype[two[4].itemPropValue]
    // //号牌底色
    // two[5].itemPropValue = code.licensecolor[two[5].itemPropValue]
    // //行驶区域
    // two[13].itemPropValue = code.runregion[two[13].itemPropValue]
    // //证件类型
    // two[14].itemPropValue = code.idtype[two[14].itemPropValue]
    // //条款类型
    // two[21].itemPropValue = code.clausetype[two[21].itemPropValue]
