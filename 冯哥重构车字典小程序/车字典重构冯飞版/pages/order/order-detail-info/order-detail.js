...
Page({
    ...
    data: {
        ...
        share_path: 'pages/order/order-detail-info/order-detail',
    },
    ...
    callback: function (car_data) {
      ...
      var that = this;
      // car_data.result.plate = car_data.result.plate==null?"":  car_data.result.plate.toUpperCase();
      // car_data.result.type = car_data.result.type==null?"": car_data.result.type.toUpperCase();
      // car_data.result.vin = car_data.result.vin==null?"": car_data.result.vin.toUpperCase();
      // car_data.result.engine = car_data.result.engine==null?"": car_data.result.engine.toUpperCase();
      
      //console.log('车辆状态', car_data.result.state);

      //隐藏用户信息
      //car_data.result.man = util.encryptionStr(car_data.result.man, 1);
